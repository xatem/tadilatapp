...
<div class="ust" id="ust">
 ...
 <p><strong>Üye kayıt</strong></p>
        ...
        <form id="form1" name="form1" method="post" action="">
          ...
          <input type="text" name="email" id="textfield" placeholder="E-Posta" />
        </form><br />

         <form id="form1" name="form1" method="post" action="">
          <label for="textfield"></label>
          <input type="password"  name="sifre" id="textfield" placeholder="Şifre" />
        </form><br />
...
<form id="form1" name="form1" method="post" action="">
          <label for="textfield">
            <input type="textfield" name="ad"  placeholder="Ad" id="textfield2" />
          </label>
</form><br />
  ...
  <br />
   <div class="select12" id="select12">
    ...
    <h56>Kampanyalar, indirimler ve haberler ile ilgili e-posta almak istiyorum.</h56>
        ...
        <br />
        <div class="button" id="button">ÜYE OL</div>
